          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <div className="flex items-center gap-1.5">
                ...
                <span
                  title="Sample content — an illustrative briefing, not generated by a live model."
                  className="rounded-full border border-primary/20 bg-primary/10 px-1.5 py-px text-[10px] font-medium tracking-wide text-primary uppercase"
                >
                  Sample
                </span>
              </div>
